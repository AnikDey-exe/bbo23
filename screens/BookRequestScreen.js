...
export default class BookRequestScreen extends Component {
  ...
  addRequest = async (bookName, reasonToRequest) => {
    ...
    var books = await BookSearch.searchbook(bookName, 'AIzaSyCEC5YHJXZr9opnYy8IRzRg92-zW6CujGA');
  ...
  componentDidMount() {
    ...
    // var book =BookSearch.searchbook("rich ",'AIzaSyCEC5YHJXZr9opnYy8IRzRg92-zW6CujGA')
  }
  //
  render() {
